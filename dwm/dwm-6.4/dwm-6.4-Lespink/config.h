...
static const char col_gray2[]       = "slateblue4";         /* border (unfocused )*/
static const char col_gray5[]       = "slateblue1";         /* border (focused) */
static const char col_gray3[]       = "lightblue";       /* foreground */
static const char col_gray4[]       = "lightblue";       /* foreground (selected) */
static const char col_cyan[]        = "slateblue1";    /* accent color */
