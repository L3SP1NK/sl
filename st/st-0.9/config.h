...
static char *font = "MartianMono NFM Cond:pixelsize=18:antialias=true:autohint=true:style=regular";
//static char *font = "sf mono:pixelsize=18:antialias=true:autohint=true:style=medium";
